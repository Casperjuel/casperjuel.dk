...
export const metadata: Metadata = {
  ...
  description:
    "Creative Developer with 11+ years of experience crafting digital experiences that feel alive. Specializing in React, Next.js, motion design, and creative coding. Based in Copenhagen.",
  keywords: [
    "Creative Developer",
    "Frontend Developer",
    "React Developer",
