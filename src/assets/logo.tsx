...
export const Logo = () => (
  <svg x="0px" y="0px" viewBox="0 0 338.1 391.3">
    <path
      ...
      strokeMiterlimit="10"
      d="M318.1,112.8C268.9,129,268.9,129,226,151.5l-4.6,2.4l-0.7,5.2c-0.4,3.1-0.8,6.2-1.2,9.4
    ...
    <path
      fill="white"
      d="M221.2,47.3c10.4-4.6,16.4-6.9,19.1-18.5c13.3-34.3-37.3-39.6-41-6.9C197.9,34,207.4,50.3,221.2,47.3"
    ></path>
  </svg>
);
